...
function Main( {data} ) {
    ...
    function artir(){
        if(count<data.length) setCount(count+8)
        else setCount(8)
    }
                ...
                <main>
                    ...
                    <div className="text-center py-3.5">
                        <button onClick={artir} id="btn"
                            className="bg-[#85c01f] cursor-pointer text-white px-3.5 py-1.5 rounded-[5px]">{count<data.length ? '+ 8 elave et!' : 'Evvele'}</button>
                    </div>
